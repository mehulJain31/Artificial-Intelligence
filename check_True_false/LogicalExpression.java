...
public class LogicalExpression 
{
		...
		public void unique_symbols( List<String>symbols ) // get the unique symbols
		{

		  if ( !(this.uniqueSymbol == null) )
		  {
			  
		  	if(!(symbols.contains(this.uniqueSymbol)))
		  ...
		  else 
		  {
			  ...
			  for( Enumeration e = this.subexpressions.elements(); e.hasMoreElements(); ) 
			  {
				  ...
				  nextExpression.unique_symbols(symbols);
			  }
		...
		public void get_symbols( ArrayList<String> symbol_array )  // for getting the symbols
		{

		  if ( !(this.uniqueSymbol == null) )
		  {
			  symbol_array.add(this.uniqueSymbol);
		  } 
		  else 
		  {
			  // else the symbol is a nested logical expression not a unique symbol
